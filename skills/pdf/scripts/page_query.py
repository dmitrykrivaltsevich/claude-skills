...
# dependencies = []
# ///
"""Reopen narrow slices from markdown/text page artifacts."""
...
@precondition(
    ...
    "Markdown/text page is not readable",
)
@precondition(
...
def main(argv: list[str] | None = None) -> None:
    ...
    emit_json_result(result, output_path=args.output, artifact_kind="pdf-page-query")
