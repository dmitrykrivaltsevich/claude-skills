...
- FORBIDDEN: index.md, log.md, .kb/*, sources/, other stagings, kb:lint, editing .kb/rules.md. Rule ideas go to staging/%%SOURCE_ID%%/rules-proposals.md (write directly: one bullet + evidence quote each).
