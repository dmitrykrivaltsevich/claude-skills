...
init = load_script_module("kb_test_search_init", "init.py")
search = load_script_module("kb_test_search_script", "search.py")
ContractViolationError = search.ContractViolationError
