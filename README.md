...
| [kb](skills/kb/) | LLM-curated local knowledge bases. Extracts knowledge from sources (articles, papers, books), creates richly interlinked Obsidian-compatible entries, tracks citations, detects contradictions, and supports cyclic deep analysis and graph topology analysis for discovering hidden connections and structural gaps. |
